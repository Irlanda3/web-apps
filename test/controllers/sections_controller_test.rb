...
class SectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create section" do
    assert_difference('Section.count') do
      post sections_url, params: { section: { course_id: @section.course_id, number: @section.number } }
    end
  ...
  test "should update section" do
    patch section_url(@section), params: { section: { course_id: @section.course_id, number: @section.number } }
